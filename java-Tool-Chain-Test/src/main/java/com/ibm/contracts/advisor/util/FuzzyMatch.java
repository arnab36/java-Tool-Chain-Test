...
public class FuzzyMatch {
	...
	*/
	...
	public static TreeMap<Integer, String> getNearest(String titleText, List<String> templateList) {
		
		TreeMap<Integer, String> resultSet = new TreeMap<Integer, String>();
		System.out.println("Title text :: " + titleText);
		
		for(String val:templateList){
			try {
				resultSet.put(FuzzySearch.ratio(titleText,val), val);
			}catch(Exception e){
				e.printStackTrace();
			}
	...
	public static void main(String[] args) {        
		...
		System.out.println(FuzzySearch.ratio("web services as a software", "software as a services"));
		System.out.println(FuzzySearch.ratio("CSK vs RCB", "RCB vs CSK"));
