...
public class StaticScoreCalculator implements Constants {
	...
	//	int totalNumberOfClasses = countClass(template_class_list);

		float TemplateMatchingScore = ((float) (tempSum) / ((float) (template_class_list.size()))) * 100;
	...
	private static IndexSentencePair SectionstaticTextScore_prev(String docClass,
			JSONArray contentResultDocument, JSONObject MP_TemplateJson) {
		// TODO Auto-generated method stub
		int TotalStaticSentences, MatchIndex = 0;
		float highestProbability = 0;
